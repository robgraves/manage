...
echo $(whiptail --backtitle "$back_title" --title "Student Account Menu" --menu "" $menu_dim "A" "Add Student" "D" "Remove Student" "W" "Remove All Students" "V" "Student listing" "L" "Student last log-in" "X" "Student disk usage" "Q" "Quit" --notags --ok-button " Select " --cancel-button " Back " 3>&1 1>&2 2>&3)
