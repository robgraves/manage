...
echo $(whiptail --backtitle "$back_title" --title "Instructor Accounts" --menu "" $menu_dim "A" "Add Instructor" "D" "Remove Instructor" "W" "Remove All Instructors" "V" "Instructor listing" "L" "Instructor last log-in" "X" "Instructor disk usage" "Q" "Quit" --notags --ok-button " Select " --cancel-button " Back " 3>&1 1>&2 2>&3)
