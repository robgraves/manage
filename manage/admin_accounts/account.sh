...
echo $(whiptail --backtitle "$back_title" --title "Instructor Accounts" --menu "" $menu_dim "A" "Add A User" "D" "Remove A User" "W" "Remove All Users" "V" "View Users" "X" "Disk Usage" "Q" "Quit" --notags --ok-button " Select " --cancel-button " Back " 3>&1 1>&2 2>&3)
